...
<head>
    ...
    <!-- Espaço reservado para estilizar os estilos de cada view que estender esse layout -->
...
<body>
    ...
    <div class="d-flex align-items-stretch">
        ...
        <div class="page-content">
            ...
            <section class="no-padding-top no-padding-bottom">
                <!-- Espaço reservado para estilizar o conteudo de cada view que estender esse layout -->
    ...
    <!-- Espaço reservado para estilizar os scripts de cada view que estender esse layout -->
